...
//        System.out.println(myAtoi("3.14159"));
    ...
    public int myAtoi(String str) {
        ...
        int multiplyNum = str.charAt(0) == '-' ? -1 : 1;
        int result = 0;
        ...
        while (index < length) {
            ...
            if (c >= '0' && c <= '9') {
                if (multiplyNum > 0) {
                    if (result*multiplyNum > Integer.MAX_VALUE/10 || (result*multiplyNum == Integer.MAX_VALUE/10 && c-'0' > 7)) {
                        return Integer.MAX_VALUE;
                    }
                } else {
                    if (result*multiplyNum < Integer.MIN_VALUE/10 || (result*multiplyNum == Integer.MIN_VALUE/10 && (c-'0')*multiplyNum < -8)) {
